...
{
    private	//declaration of array type
    $in = [
    ...
    public function __construct()// declaration of function
    {
    ...
    private function foot() : string// footer function
    {
        return '
    <footer>
    ...
    private function html() : string// html function
    {
